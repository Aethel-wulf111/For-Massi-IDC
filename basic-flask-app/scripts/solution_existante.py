...
def solution_deja_existante(filename):
    ...
    return analyze_by_intezer(dictionary[exe_file]["md5Hash"]), Analyse_by_Scanii('921da0c9cc672ad35a7f5f496eaf0e6c:686d24459',exe_file), open_json_file_and_print(dictionary[exe_file]["md5Hash"])
